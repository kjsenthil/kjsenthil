...
const simulateProjectionMain: AzureFunction = async function (
  context: Context,
  req: HttpRequest
): Promise<void> {
  let responseBody = {};
...
function getSimulateProjection(
...
function setDefaultInputValues(inboundPayload: RequestPayload) {
  if (
    inboundPayload.feesPercentage == null ||
    typeof inboundPayload.feesPercentage == "undefined"
  )
    inboundPayload.feesPercentage = 0;

  if (
    inboundPayload.upfrontContribution == null ||
    typeof inboundPayload.upfrontContribution == "undefined"
  )
    inboundPayload.upfrontContribution = 0;

  if (
    inboundPayload.postGoal == null ||
    typeof inboundPayload.postGoal == "undefined"
  ) {
    inboundPayload.postGoal = inboundPayload.preGoal;
  } else {
    if (typeof inboundPayload.postGoal.expectedReturnPercentage == "undefined")
      inboundPayload.postGoal.expectedReturnPercentage =
        inboundPayload.preGoal.expectedReturnPercentage;

    if (typeof inboundPayload.postGoal.volatilityPercentage == "undefined")
      inboundPayload.postGoal.volatilityPercentage =
        inboundPayload.preGoal.volatilityPercentage;

    if (typeof inboundPayload.postGoal.ZScoreLowerBound == "undefined")
      inboundPayload.postGoal.ZScoreLowerBound =
        inboundPayload.preGoal.ZScoreLowerBound;

    if (typeof inboundPayload.postGoal.ZScoreUpperBound == "undefined")
      inboundPayload.postGoal.ZScoreUpperBound =
...
function validateDefaultInputs(
  ...
  if (
    typeof inboundPayload.timeHorizonToProject == "undefined" ||
    inboundPayload.timeHorizonToProject <= 0
  ) {
  ...
  if (typeof inboundPayload.feesPercentage != "undefined")
    if (
      inboundPayload.feesPercentage < 0 ||
      inboundPayload.feesPercentage > 100
    ) {
      const error: ValidationError = {
        code: "val-simulateproj-002",
        property: "feesPercentage",
        message:
          "feesPercentage_must_be_a_percentage_value_between_zero_and_one_hundred",
      };
      errors.push(error);
    }
  ...
  if (
    typeof inboundPayload.monthlyContribution == "undefined" ||
    inboundPayload.monthlyContribution < 0
  ) {
    const error: ValidationError = {
  ...
  if (
    typeof inboundPayload.currentPortfolioValue == "undefined" ||
    inboundPayload.currentPortfolioValue < 0
  ) {
    const error: ValidationError = {
  ...
  if (
    inboundPayload.includeGoal &&
    (typeof inboundPayload.drawdownType == "undefined" ||
      drawDownTypes.indexOf(inboundPayload.drawdownType) < 0)
  ) {
    const error: ValidationError = {
      code: "val-simulateproj-008",
      property: "drawdownType",
      message:
        "drawdownType_must_be_one_of_the_values_" +
        Object.values(DrawdownType).join("_"),
    };
    errors.push(error);
  }
}

function validateDrawdownOneOff(
  inboundPayload: RequestPayload,
  errors: Array<ValidationError>
) {
  if (inboundPayload.drawdownType == DrawdownType.OneOff) {
    if (typeof inboundPayload.drawdownOneOff == "undefined") {
      ...
      if (
        typeof inboundPayload.drawdownOneOff.targetAmount == "undefined" ||
        inboundPayload.drawdownOneOff.targetAmount <= 0
      ) {
        const error: ValidationError = {
      ...
      if (
        typeof inboundPayload.drawdownOneOff.targetDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownOneOff.targetDate)
      ) {
        const error: ValidationError = {
        ...
        if (
          parseDate(inboundPayload.drawdownOneOff.targetDate) >= currentDate
        ) {
          const error: ValidationError = {
...
function validateDrawdownMonthly(
  inboundPayload: RequestPayload,
  errors: Array<ValidationError>
) {
  if (inboundPayload.drawdownType == DrawdownType.Monthly) {
    if (typeof inboundPayload.drawdownMonthly == "undefined") {
      ...
      if (
        typeof inboundPayload.drawdownMonthly.amount == "undefined" ||
        inboundPayload.drawdownMonthly.amount <= 0
      ) {
        const error: ValidationError = {
      ...
      if (
        typeof inboundPayload.drawdownMonthly.startDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownMonthly.startDate)
      ) {
        const error: ValidationError = {
      ...
      if (
        typeof inboundPayload.drawdownMonthly.endDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownMonthly.endDate)
      ) {
        const error: ValidationError = {
      ...
      if (
        inboundPayload.drawdownMonthly.startDate &&
        inboundPayload.drawdownMonthly.endDate &&
        monthsDiff(
          parseDate(inboundPayload.drawdownMonthly.startDate),
          parseDate(inboundPayload.drawdownMonthly.endDate)
        ) < 1
      ) {
        const error: ValidationError = {
          ...
          property: "drawdownMonthly.endDate",
          message:
            "drawdownMonthly_endDate_must_be_at_least_one_month_greater_than_startDate",
        };
        errors.push(error);
      }
    }
...
function validateDrawdownAnnually(
  inboundPayload: RequestPayload,
  errors: Array<ValidationError>
) {
  if (inboundPayload.drawdownType == DrawdownType.Annual) {
    if (typeof inboundPayload.drawdownAnnually == "undefined") {
      ...
      if (
        typeof inboundPayload.drawdownAnnually.amount == "undefined" ||
        inboundPayload.drawdownAnnually.amount <= 0
      ) {
        const error: ValidationError = {
      ...
      if (
        typeof inboundPayload.drawdownAnnually.startDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownAnnually.startDate)
      ) {
        const error: ValidationError = {
      ...
      if (
        typeof inboundPayload.drawdownAnnually.endDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownAnnually.endDate)
      ) {
        const error: ValidationError = {
      ...
      if (
        inboundPayload.drawdownAnnually.startDate &&
        inboundPayload.drawdownAnnually.endDate &&
        parseDate(inboundPayload.drawdownAnnually.endDate).getFullYear() -
          parseDate(inboundPayload.drawdownAnnually.startDate).getFullYear() <
          1
      ) {
        const error: ValidationError = {
          ...
          property: "drawdownAnnually.endDate",
          message:
            "drawdownAnnually_endDate_must_be_at_least_one_year_greater_than_startDate",
        };
        errors.push(error);
      }
    }
...
function validateDrawdownRetirement(
  inboundPayload: RequestPayload,
  errors: Array<ValidationError>
) {
  ...
  if (inboundPayload.drawdownType == DrawdownType.Retirement) {
    if (typeof inboundPayload.drawdownRetirement == "undefined") {
      ...
      if (
        typeof inboundPayload.drawdownRetirement.regularDrawdown ==
          "undefined" ||
        ...
        const error: ValidationError = {
          ...
          message:
            "drawdownRetirement_regularDrawdown_must_be_a_positive_number",
        };
        errors.push(error);
      }

      if (
        typeof inboundPayload.drawdownRetirement.startDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownRetirement.startDate)
      ) {
        const error: ValidationError = {
      ...
      if (
        typeof inboundPayload.drawdownRetirement.endDate == "undefined" ||
        !Date.parse(inboundPayload.drawdownRetirement.endDate)
      ) {
        const error: ValidationError = {
      ...
      if (
        inboundPayload.drawdownRetirement.startDate &&
        inboundPayload.drawdownRetirement.endDate &&
        monthsDiff(
        ...
        const error: ValidationError = {
          ...
          property: "drawdownRetirement.endDate",
          message:
            "drawdownRetirement_endDate_must_be_at_least_one_month_greater_than_startDate",
        };
        errors.push(error);
      }
      ...
      if (typeof inboundPayload.drawdownRetirement.lumpSum != "undefined") {
        if (
          typeof inboundPayload.drawdownRetirement.lumpSum.amount != "undefined"
        ) {
          if (inboundPayload.drawdownRetirement.lumpSum.amount < 0) {
            const error: ValidationError = {
              ...
              message:
                "drawdownRetirement_lumpSum_amount_must_be_a_positive_number_or_zero",
            };
            errors.push(error);
          }

          if (
            typeof inboundPayload.drawdownRetirement.lumpSum.date ==
              "undefined" ||
            !Date.parse(inboundPayload.drawdownRetirement.lumpSum.date)
          ) {
            const error: ValidationError = {
            ...
            if (
              ...
              if (
                ...
                const error: ValidationError = {
                  ...
                  property: "drawdownRetirement.lumpSum.date",
                  message:
                    "drawdownRetirement_lumpSum_date_must_be_less_or_equal_than_drawdownRetirement_startDate",
                };
                errors.push(error);
              }
          }
      ...
      if (
        typeof inboundPayload.drawdownRetirement.remainingAmount != "undefined"
      )
        if (inboundPayload.drawdownRetirement.remainingAmount < 0) {
          const error: ValidationError = {
            ...
            message:
              "drawdownRetirement_remainingAmount_must_be_a_positive_number_or_zero",
          };
          errors.push(error);
        }

      if (
        typeof inboundPayload.drawdownRetirement.statePensionAmount !=
        "undefined"
      ) {
        if (inboundPayload.drawdownRetirement.statePensionAmount < 0) {
          const error: ValidationError = {
            ...
            message:
              "drawdownRetirement_statePensionAmount_must_be_a_positive_number_or_zero",
          };
          errors.push(error);
        } else if (
          inboundPayload.drawdownRetirement.statePensionAmount > 0 &&
          inboundPayload.drawdownRetirement.regularDrawdown <
            statePensionLimitValue &&
          (inboundPayload.drawdownRetirement.remainingAmount ?? 0) == 0 &&
          (inboundPayload.drawdownRetirement.lumpSum?.amount ?? 0) == 0
        ) {
          const error: ValidationError = {
            code: "val-simulateproj-041",
            property: "drawdownRetirement",
            message:
              "drawdownRetirement_statePensionAmount_equal_zero_regularDrawdown_less_than_" +
              statePensionLimitValue +
              "_remainingAmmount_equals_zero_and_lumpSumAmount_equals_zero_cannot_be_at_same_time",
          };
          errors.push(error);
        }
      }
...
function validatePreGoal(
  ...
  if (typeof inboundPayload.preGoal == "undefined") {
    ...
    if (
      typeof inboundPayload.preGoal.expectedReturnPercentage == "undefined" ||
      ...
      const error: ValidationError = {
        ...
        message:
          "preGoal_expectedReturnPercentage_must_be_a_percentage_value_between_zero_and_one_hundred",
      };
      errors.push(error);
    }

    if (
      typeof inboundPayload.preGoal.volatilityPercentage == "undefined" ||
      inboundPayload.preGoal.volatilityPercentage < 0 ||
      ...
      const error: ValidationError = {
        ...
        message:
          "preGoal_volatilityPercentage_must_be_a_percentage_value_between_zero_and_one_hundred",
      };
      errors.push(error);
    }

    if (
      typeof inboundPayload.preGoal.ZScoreLowerBound == "undefined" ||
      inboundPayload.preGoal.ZScoreLowerBound > 0
    ) {
      const error: ValidationError = {
        code: "val-simulateproj-035",
        property: "preGoal.ZScoreLowerBound",
        message:
          "preGoal_ZScoreLowerBound_must_be_a_number_bellow_zero_or_zero",
      };
      errors.push(error);
    }

    if (
      typeof inboundPayload.preGoal.ZScoreUpperBound == "undefined" ||
      inboundPayload.preGoal.ZScoreUpperBound < 0
    ) {
      const error: ValidationError = {
...
function validatePostGoal(
  ...
  if (typeof inboundPayload.postGoal != "undefined") {
    if (typeof inboundPayload.postGoal.expectedReturnPercentage != "undefined")
      if (
        inboundPayload.postGoal.expectedReturnPercentage < 0 ||
        inboundPayload.postGoal.expectedReturnPercentage > 100
      ) {
        const error: ValidationError = {
          code: "val-simulateproj-037",
          property: "postGoal.expectedReturnPercentage",
          message:
            "postGoal_expectedReturnPercentage_must_be_a_percentage_value_between_zero_and_one_hundred",
        };
        errors.push(error);
      }
    ...
    if (typeof inboundPayload.postGoal.volatilityPercentage != "undefined")
      if (
        inboundPayload.postGoal.volatilityPercentage < 0 ||
        inboundPayload.postGoal.volatilityPercentage > 100
      ) {
        const error: ValidationError = {
          code: "val-simulateproj-038",
          property: "postGoal.volatilityPercentage",
          message:
            "postGoal_volatilityPercentage_must_be_a_percentage_value_between_zero_and_one_hundred",
        };
        errors.push(error);
      }
    ...
    if (typeof inboundPayload.postGoal.ZScoreLowerBound != "undefined")
      if (inboundPayload.postGoal.ZScoreLowerBound > 0) {
        const error: ValidationError = {
          ...
          message:
            "postGoal_ZScoreLowerBound_must_be_a_number_bellow_zero_or_zero",
        };
        errors.push(error);
      }
    ...
    if (typeof inboundPayload.postGoal.ZScoreUpperBound != "undefined")
      if (inboundPayload.postGoal.ZScoreUpperBound < 0) {
        const error: ValidationError = {
          ...
          message:
            "postGoal_ZScoreUpperBound_must_be_a_positive_number_or_zero",
        };
        errors.push(error);
      }
  }
