const API_ENDPOINTS = {
  ...
  MYACCOUNT_AGGREGATED_NET_CONTRIBUTIONS: '/myaccount/netcontribution-accounts-aggregated',
  MYACCOUNT_AGGREGATED_PERFORMANCE_ACCOUNTS: '/myaccount/performance-accounts-aggregated',
  ...
  MYACCOUNT_AGGREGATED_BREAKDOWN_ALLOCATION: '/myaccount/aggregated-breakdown-allocation',
  ...
  SIMULATE_PROJECTIONS: '/projections/simulate-projection',
